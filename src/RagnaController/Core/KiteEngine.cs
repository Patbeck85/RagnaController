...
namespace RagnaController.Core
{
    ...
    public class KiteEngine
    {
        ...
        // Click interval timer for retreat click-moves
        ...
        private void UpdateAttacking(int tickMs)
        {
            ...
            // Fire attack key
            if (_attackCooldown <= 0)  // fire attack on cooldown, hold ground only prevents retreat
            {
        ...
        private void UpdateRetreating(int tickMs)
        {
            ...
            // Click-to-move: left-click in retreat direction every ~180ms (reliable timer)
            _retreatClickTimer -= tickMs;
            if (_retreatClickTimer <= 0)
            {
                InputSimulator.LeftClick();
                _retreatClickTimer = 180;
            }
        ...
        private void BeginRetreat()
        {
            ...
            _retreatAccumX  = 0f;
            _retreatAccumY  = 0f;
            _retreatClickTimer = 0; // Fire first click immediately
